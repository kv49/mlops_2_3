...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/user02/mlflow/"
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("get_data")
 
key = "AIzaSyDaRFQLT_ysQcizyZmMsymbNnyTxr1y-3E"
api = Api(api_key=key)
...
#            s += int(item['snippet']['topLevelComment']['snippet']['likeCount'])
            s += len(item['snippet']['topLevelComment']['snippet']['textDisplay'].split())
    mlflow.log_artifact(local_path="/home/user02/Projects/mlops_2_3/scripts/get_data.py",
                        artifact_path="get_data code")
    mlflow.end_run()

with open('/home/user02/Projects/mlops_2_3/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))